...
type CustomerClient interface {
	GetCustomer(ctx context.Context, in *GetCustomersRequest, opts ...grpc.CallOption) (*GetCustomerResponse, error)
}
...
func (c *customerClient) GetCustomer(ctx context.Context, in *GetCustomersRequest, opts ...grpc.CallOption) (*GetCustomerResponse, error) {
	out := new(GetCustomerResponse)
	err := c.cc.Invoke(ctx, "/customerpb.Customer/GetCustomer", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type CustomerServer interface {
	GetCustomer(context.Context, *GetCustomersRequest) (*GetCustomerResponse, error)
...
func (UnimplementedCustomerServer) GetCustomer(context.Context, *GetCustomersRequest) (*GetCustomerResponse, error) {
...
func _Customer_GetCustomer_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/customerpb.Customer/GetCustomer",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CustomerServer).GetCustomer(ctx, req.(*GetCustomersRequest))
	}
